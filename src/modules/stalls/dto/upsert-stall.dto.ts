...
class StallMenuProductDto {
  ...
  @ApiProperty({
    example: 1500,
    description: 'Preço em centavos (ex.: 1500 = R$ 15,00).',
  })
...
class StallMenuCategoryDto {
  ...
  @ApiProperty({
    ...
    example: [{ name: 'Pastel de queijo', priceCents: 1200, order: 0 }],
  })
...
export class UpsertStallDto {
  @ApiProperty({
    ...
    description: 'Nome do PDV (obrigatório).',
  })
  ...
  @ApiProperty({
    ...
    example: {
      ...
      needsGas: false,
      gasNotes: null,
      notes: 'Próximo ao ponto de energia',
    },
  })
  @ValidateNested()
  @Type(() => StallPowerNeedDto)
