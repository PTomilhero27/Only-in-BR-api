...
export class CreateAssinafySignUrlDto {
  @ApiProperty({
    example: '2d8b6c2a-5a4b-4d52-8e1a-0a5b9a6b9d11',
    description: 'ID da feira (Fair.id)',
  })
  @IsUUID()
  fairId: string;
  ...
  @ApiProperty({
    example: 'ckzowner123',
    description: 'ID do expositor (Owner.id)',
  })
  @IsString()
  @MinLength(1)
  ownerId: string;
  ...
  @ApiProperty({
    ...
    description: 'Nome do signatário (expositor)',
  })
  @IsString()
  @MinLength(2)
  name: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Nome/brand opcional para compor o filename do PDF enviado à Assinafy',
  })
  @IsOptional()
  @IsString()
  brand?: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Expiração (ISO) do assignment/link (opcional). Se omitido, não envia expiração.',
  })
  @IsOptional()
  @IsISO8601()
  expiresAtISO?: string;
